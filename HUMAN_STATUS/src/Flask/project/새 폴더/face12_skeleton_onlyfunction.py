...
try:
    ...
    body_language_model_path = 'C:/eGovFrame-4.0.0/workspace.edu/Z_Project6/src/Flask/project/Body-Langugae-Decoder-Using-Mediapipe-master/body_language.pkl'
...
predictor_path = "C:/eGovFrame-4.0.0/workspace.edu/Z_Project6/src/Flask/project/shape_predictor_68_face_landmarks.dat"
...
def draw_korean_text(image, text, position, font_path, font_size, font_color):
    ...
    font_path = os.path.abspath(r"C:\eGovFrame-4.0.0\workspace.edu\Z_Project6\NanumGothic.ttf")
...
def capture_video():
    ...
    while True:
        ...
        for i, region in enumerate(regions):
            ...
            if user_state["ALERT"]:
                # 한글 텍스트 렌더링을 위한 코드
                frame = draw_korean_text(frame, "졸음!", (50, 100), r"C:\eGovFrame-4.0.0\workspace.edu\Z_Project6\NanumGothic.ttf", 100, (0, 0, 255))
            else:
                frame = draw_korean_text(frame, "집중", (50, 100), r"C:\eGovFrame-4.0.0\workspace.edu\Z_Project6\NanumGothic.ttf", 100, (0, 255, 0))
